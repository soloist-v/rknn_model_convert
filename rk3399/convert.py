...
Examples:
  # Basic conversion
  python convert.py model.onnx rk3399pro
  
  # Specify output and data type
  python convert.py model.onnx rk3399pro --dtype i8 --output model.rknn
  
  # Floating point model (no quantization)
  python convert.py model.onnx rk3399pro --dtype fp --no-quant
  
  # Custom dataset
  python convert.py model.onnx rk3399pro --dataset datasets/imagenet/ILSVRC2012_img_val_samples/dataset_20.txt

Notes:
  - For rk3399pro: use 'i8' or 'fp'
